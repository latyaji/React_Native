       ...
       <ScrollView>
               <View style={{backgroundColor:"#dedee3",height:windowHeight}}>
                 ...
                 <View style={{width:this.state.windowWidth,height:this.state.windowHeight,position:"absolute"}}>
                           ...
                           <Text style={{color:"#fff",fontSize:18,fontWeight:"bold",marginLeft:12,fontSize:20}}>Sign In</Text>
                           ...
                           <View style={{width:"85%",height:340,backgroundColor:"#fff",alignSelf:"center",marginTop:20,borderRadius:12}}>
                                 <View>
                                   ...
                                   <View style={{alignItems:"center",marginTop:20}}>
                                        ...
                                        onPress={()=>this.props.navigation.navigate('Apie')}
                                         style={{width:"90%"}}>
                                                       <Text style={{backgroundColor:"#8b38e6",padding:12,textAlign:"center",color:"#fff",fontWeight:"bold",borderRadius:8}}>Sign In</Text>
                                         </TouchableOpacity> 
                                   </View>
                    ...
                    <View style={{paddingBottom:12,backgroundColor:"#fff",borderRadius:12}}>
                     ...
                     <TouchableOpacity  style={{alignSelf:'center',marginTop:20,marginBottom:20}}><Text>SKIP</Text></TouchableOpacity>       
                           </View> 
             </View> 
           </View>        
       </ScrollView>
